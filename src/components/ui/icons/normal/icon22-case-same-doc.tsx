    ...
    return (
        <svg className={classNames("fill-current", className)} viewBox="0 0 24 24" {...rest}>
            ...
            <g fill="none">
                ...
                <path stroke="#191919" strokeLinecap="round" strokeLinejoin="round"
                    d="M13.375 22.542h8.25a.917.917 0 0 0 .917-.917V6.935a5.476 5.476 0 0 0-5.477-5.477H6.042a.917.917 0 0 0-.917.917v6.417" strokeWidth="1" />
                <path stroke="#191919" strokeLinecap="round" strokeLinejoin="round" d="M17.959 1.532v3.593a.916.916 0 0 0 .916.917h3.593" strokeWidth="1" />
                ...
                <path stroke="#191919" strokeLinecap="round" strokeLinejoin="round" d="M6.959 22.542a5.5 5.5 0 1 0 0-11a5.5 5.5 0 0 0 0 11m-1.834-6.417h3.667m-3.667 1.833h3.667"
                    strokeWidth="1" />
            </g>
        </svg>
    );
