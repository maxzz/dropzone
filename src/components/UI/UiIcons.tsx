...
export function IconDocumentsAccepted(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 48 48" fill="currentColor" {...props}>
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M38 15v21a3 3 0 0 1-3 3H17a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3h11l10 10zm-10 1a1 1 0 0 1-1-1V7H17a1 1 0 0 0-1 1v28a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V16h-8zm1-7.172L34.172 14H29V8.828z" ></path>
