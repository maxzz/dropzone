    ...
    return (
        <svg width="1em" height="1em" viewBox="0 0 48 48" {...props}>
            <g fill="none">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M24 37a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5z" fill="currentColor"></path>
                <path d="M24 12v16" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"></path>
            </g>
        </svg>
    );
}
