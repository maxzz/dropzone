...
export function Tab1_MatchWeb({ editorUrlsAtom }: { editorUrlsAtom: MatchWebStateAtom; }) {
    return (
        <div className="p-4">
            <div className="grid grid-cols-1">
                <Section_Ourl editorUrlsAtom={editorUrlsAtom} />
                {/* Separator */} {/* <div className="mt-2 mb-4 w-full border-t border-gray-300" /> */}
                <Section_Murl editorUrlsAtom={editorUrlsAtom} />
                <Section_Qurl editorUrlsAtom={editorUrlsAtom} />
            </div>
        </div>
    );
}
