...
export function BtnSvgPreview({ form, formIdx, selectRowAtoms, small, setSmall }: BtnPreviewResult) {
            ...
            {!small && (
                <div className="col-start-1 row-start-1 col-span-2 row-span-2">
                    <CardSvgPreview
                        ...
                        small={small}
                        form={form}
                        selectedIdx={selectedRow.fieldIdx}
                        onSelectedIdx={(selectedIdx: number) => setSelectedRow({ fieldIdx: selectedIdx, formType: form.type })}
                    />
                </div>
            )}
        </div>
